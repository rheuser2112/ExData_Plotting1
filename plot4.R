...
## 2
plot(mydf.1$DateTime, mydf.1$Voltage, type = "l", 
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
       cex = 0.75, box.lwd = 0,lty=c(1,1,1), lwd= c(1,1,1),col = c("black", "red", "blue") )

## 4
plot(mydf.1$DateTime, mydf.1$Global_reactive_power, type = "l", 
